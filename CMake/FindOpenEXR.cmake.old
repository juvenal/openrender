...
IF(OPENEXR_INCLUDE_DIR)
    FILE(TO_CMAKE_PATH "${OPENEXR_INCLUDE_DIR}" __OPENEXR_INCLUDE_DIR_TMP)
    SET(OPENEXR_INCLUDE_DIR "${__OPENEXR_INCLUDE_DIR_TMP}")
...
IF(OPENEXR_LIBRARY_DIR)
    FILE(TO_CMAKE_PATH "${OPENEXR_LIBRARY_DIR}" __OPENEXR_LIBRARY_DIR_TMP)
    SET(OPENEXR_LIBRARY_DIR "${__OPENEXR_LIBRARY_DIR_TMP}")
