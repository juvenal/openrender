; ModuleID = '/Volumes/Projects/Development/CLI/openrender-worktrees/012-jit-parity-followups/shaders/show_st_hsv.slo'
source_filename = "show_st_hsv"

@space_str = private unnamed_addr constant [4 x i8] c"hsv\00", align 1

define void @show_st_hsv(i32 %0, ptr %1, ptr %2) {
entry:
  ...
  store float 1.000000e+00, ptr %lit, align 4
  ...
  call void @op_cfrom(ptr %14, i32 3, ptr @space_str, ptr %16, i32 3, i32 %0, ptr %2)
...
declare void @op_cfrom(ptr, i32, ptr, ptr, i32, i32, ptr)
