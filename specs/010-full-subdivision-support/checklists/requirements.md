...
- Several functional requirements (FR-001–FR-003, FR-004, FR-011, FR-012) reference
  ...
  *architectural constraints* set explicitly by the feature owner — the geometry/hider/
  ...
  Story 1 and FR-003/FR-011 explicitly forbid. This is treated as bounding scope, not
...
- All scope ambiguities identified during research and clarified directly with the
  feature owner before this spec was written (full scope through the Loop scheme;
  ...
  [NEEDS CLARIFICATION] markers, since none remained open after that discussion.
