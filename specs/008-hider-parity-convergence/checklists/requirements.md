...
- All three clarification questions raised during specification (displacement default, motion-blur verification scope, Option B determinism scope) were resolved in the 2026-08-01 specify session; answers are recorded in the spec's Clarifications section and reflected in FR-015/016/017, FR-018/019, and FR-025/027 respectively.
- Two further clarifications from the 2026-08-01 clarify session: (1) raytraced motion-blur parity coverage requires separate scenes per moving-geometry primitive type (patches/polygons/quadrics), reflected in FR-002/FR-018/FR-019 and Story 6; (2) the performance requirement is regression-only and explicitly excludes narrowing the pre-existing raytrace-vs-reyes speed gap, reflected in FR-030/SC-007 and the Assumptions section. A drafting gap was also corrected during this pass: FR-030/SC-007 originally scoped the perf-regression guard to reyes only, but the source audit applies it to both hiders — fixed to cover both.
