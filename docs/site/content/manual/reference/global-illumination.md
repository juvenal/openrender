...
openRender supports global illumination and photon mapping. The mechanism for global illumination is very similar to the new extensions introduced with PrMan 11.
...
![Direct photon visualization showing photon map with non-uniform shading](/openrender/static/images/Docs_DirectPhoton.jpg) ![Rendered image computed using irradiance caching with photon maps for the second bounce](/openrender/static/images/Docs_ex5_beauty.jpg)
...
Caustics can be generated by directly visualizing the caustics photon maps that openRender generates. Notice that since these photon maps are visualized directly, they need to have lots of photons. Figures below demonstrate this effect.

![Caustic visualization demonstrating light focusing through a prism and sphere](/openrender/static/images/Docs_Caustic1.jpg) ![Caustic visualization showing light concentration patterns](/openrender/static/images/Docs_Caustic2.jpg)

## Irradiance Caching

openRender can compute occlusion and/or irradiance values sparsely and interpolate them for the final rendering. This allows fast and accurate diffuse interreflections without noise. The following two shading language commands can be used:
...
![First pass image showing extrapolation artifacts with blocky patterns](/openrender/static/images/Docs_ex1_precompute.jpg) ![Second pass image showing improved result after using irradiance cache computed in first pass](/openrender/static/images/Docs_ex1_beauty.jpg)
...
Figures below further demonstrate the global illumination capabilities of openRender.

![Global illumination example created using irradiance caching via indirectdiffuse, showing ambient lighting effects](/openrender/static/images/Docs_ex3_beauty.jpg) ![Global illumination example showing additional global illumination effects](/openrender/static/images/Docs_ex3g_beauty.jpg)
