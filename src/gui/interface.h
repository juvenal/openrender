 ...
 *
 * Description:
 *   This file defines the interface for interface.
 *
 * Authors:
    ...
    protected:
        ...
        void mouseMoveEvent(int x, int y) {
            ...
            if (cameraAction) {
                ...
                case INTERFACE_LEFT_BUTTON: { // Rotate
                    vector to;
                    vector prod;
                    quaternion drag;
                ...
                case INTERFACE_RIGHT_BUTTON: { // Pan
                    vector d;
                ...
                case INTERFACE_MID_BUTTON: { // Zoom
        ...
        void keyPressEvent(int key) {
            if (key == INTERFACE_ALT_KEY || key == INTERFACE_CTRL_KEY)
                cameraAction = TRUE;
            else {
                if (view->keyDown(key) == TRUE)
                    reparse();
            }
        }
