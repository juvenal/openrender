 ...
 *
 * Description:
 *   This file implements the functionality for execute.
 *
 * Authors:
...
#define plStep()                                          \
    for (int var = 0; var < lookup->numVaryings; ++var) { \
...
#define runAmbientLights()                                                                                                       \
    if (!currentShadingState->ambientLightsExecuted) {                                                                           \
