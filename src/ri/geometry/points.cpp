 ...
 *
 * Description:
 *   This file implements the functionality for points.
 *
 * Authors:
...
// CPoints::dice() lives in geometryDispatch.cpp (real body) /
...
// Return Value			:	-
// Comments				:
void CPoints::sample(int start [[maybe_unused]], int numVertices [[maybe_unused]], float **varying, float ***locals, unsigned int &usedParameters) const {
