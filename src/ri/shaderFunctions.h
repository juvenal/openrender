 ...
 *
 * Description:
 *   This file defines the interface for shaderFunctions.
 *
 * Authors:
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// faceforward "v=vv"
#define FACEFORWARDEXPR_PRE                 \
    const float *Ng = varying[VARIABLE_NG]; \
    FUN3EXPR_PRE

#define FACEFORWARDEXPR          \
    if (dotvv(op1, Ng) > 0) {    \
        if (dotvv(op2, Ng) > 0)  \
            mulvf(res, op1, -1); \
        else                     \
...
#define FACEFORWARDEXPR_UPDATE \
    FUN3EXPR_UPDATE(3, 3, 3);  \
    Ng += 3;
...
#define CTRANSFORMSEXPR                       \
    convertColorFrom(vtmp, op3, cSystemFrom); \
...
#define TRANSFORM2EXPR       \
    mulmp(vtmp, from1, op3); \
    mulmp(res, to2, vtmp);
...
#define TRANSFORM4EXPR      \
    mulmp(vtmp, from, op3); \
    mulmp(res, op2, vtmp);

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// vtransform "p=Sp
#define VTRANSFORM1EXPR_PRE         \
    ECoordinateSystem cSystem;      \
    const float *from, *to;         \
    float *res;                     \
    const char **op1;               \
...
#define VTRANSFORM2EXPR      \
    mulmv(vtmp, from1, op3); \
    mulmv(res, to2, vtmp);
...
#define DIFFUSEEXPR_POST                   \
    exitFastLightingConditional();         \
