 ...
 *
 * Description:
 *   This file defines the interface for giFunctions.
 *
 * Authors:
...
#define IDEXPR_UPDATE(__n)                                            \
    FUN4EXPR_UPDATE(__n, 3, 3, 1)                                     \
    plStep();                                                         \
    dPdu += 3;                                                        \
    dPdv += 3;                                                        \
    du++;                                                             \
