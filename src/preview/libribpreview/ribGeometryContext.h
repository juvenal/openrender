...
class CRibGeometryContext : public CRiInterface {
    public:
        ...
        void getBasisSteps(int &uStep, int &vStep) override {
            uStep = currentAttributes_->uStep;
            vStep = currentAttributes_->vStep;
        }
        ...
        void RiPointsGeneralPolygonsV(int npolys, int *nloops, int *nvertices, int *vertices, int n, const char *tokens[], const void *params[]) override;
        ...
        void RiTrimCurve(int, int *, int *, float *, float *, float *, int *, float *, float *, float *) override {}
        void RiSphereV(float radius, float zmin, float zmax, float tmax, int n, const char *tokens[], const void *params[]) override;
        void RiConeV(float height, float radius, float tmax, int n, const char *tokens[], const void *params[]) override;
        void RiCylinderV(float radius, float zmin, float zmax, float tmax, int n, const char *tokens[], const void *params[]) override;
        void RiParaboloidV(float rmax, float zmin, float zmax, float tmax, int n, const char *tokens[], const void *params[]) override;
        void RiDiskV(float height, float radius, float tmax, int n, const char *tokens[], const void *params[]) override;
        void RiTorusV(float rmajor, float rminor, float phimin, float phimax, float tmax, int n, const char *tokens[], const void *params[]) override;
        void RiHyperboloidV(float *point1, float *point2, float tmax, int n, const char *tokens[], const void *params[]) override;
        void RiCurvesV(const char *type, int ncurves, int nverts[], const char *wrap, int n, const char *tokens[], const void *params[]) override;
