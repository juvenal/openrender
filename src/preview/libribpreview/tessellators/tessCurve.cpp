...
void tessCurve(const float *positions, int numCurves, const int *nverts, bool periodic, const float *xfrom, const float3 &col, std::vector<float3> &verts, std::vector<float3> &cols, AABB &bounds) {
    int base = 0;
