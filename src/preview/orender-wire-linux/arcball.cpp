...
ArcballCamera::ArcballCamera(const float *projMatrix16,
    ...
    float cx = from.at(0, 0) * sceneCenter.x + from.at(1, 0) * sceneCenter.y + from.at(2, 0) * sceneCenter.z + from.at(3, 0);
    float cy = from.at(0, 1) * sceneCenter.x + from.at(1, 1) * sceneCenter.y + from.at(2, 1) * sceneCenter.z + from.at(3, 1);
    float cz = from.at(0, 2) * sceneCenter.x + from.at(1, 2) * sceneCenter.y + from.at(2, 2) * sceneCenter.z + from.at(3, 2);
