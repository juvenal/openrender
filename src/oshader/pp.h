 ...
 *
 * Description:
 *   This file defines the interface for pp.
 *
 * Authors:
...
#else                    /* ! H_BSD */
#define FILENAMESIZE 256 /* Long enough until we find better	*/
#endif                   /* HOST == H_BSD */
#endif                   /* HOST == H_CPM */

#define FILESTACKSIZE 14         /* Max depth of #include	*/
#define MACROSIZE 16384          /* Max length of #define	*/
#define TOKENSIZE 5100           /* Max token length		*/
