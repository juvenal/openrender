...
struct float4 {
        float x, y, z, w;
}; // quaternion: xyz=imaginary, w=real
...
static float det4(const float m[16]) {
    ...
    return a * (f * (k * q2 - l * p) - g * (j * q2 - l * o) + h * (j * p - k * o)) - b * (e * (k * q2 - l * p) - g * (i * q2 - l * mn) + h * (i * p - k * mn)) + c * (e * (j * q2 - l * o) - f * (i * q2 - l * mn) + h * (i * o - j * mn)) - d * (e * (j * p - k * o) - f * (i * p - k * mn) + g * (i * o - j * mn));
}
